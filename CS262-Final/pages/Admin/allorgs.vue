<template >
    ...
    <div class="max-w-full mx-auto px-4"> <!-- Changed max-w-7xl to max-w-full and adjusted padding -->
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div class="bg-white rounded-lg p-6 shadow-md flex items-start space-x-4 border-2 border-gray-200">
          ...
          <div class="flex-grow">
            <h3 class="text-gray-500 text-sm font-medium">Total Organization</h3>
        ...
        <div class="bg-white rounded-lg p-6 shadow-md flex items-start space-x-4 border-2 border-gray-200">
          ...
          <div class="flex-grow">
            <h3 class="text-gray-500 text-sm font-medium">Total Org Balance</h3>
  ...
  <div class="min-h-screen bg-gray-100 p-6 mt-6 rounded-2xl">
    <div class="max-w-8xl mx-auto">
      ...
      <!-- Header -->
      <div class="mb-6">
        <h1 class="text-3xl font-bold text-base-200 mb-4 mt-3">All Organization</h1>
...
const {
  ...
  refresh,
  pending
} = useLazyFetch('/api/admin/organizations', {
  // Options
